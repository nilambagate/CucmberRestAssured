package com.Basics.postStringJsonSD;
...
//		resp.then().log().status();
	...
	public void user_validate_the_id_is_not_null(){
		...
		String createdAt = resp.getBody().jsonPath().get("createdAt");
		Assert.assertTrue(createdAt.contains(todayDate));
		}
